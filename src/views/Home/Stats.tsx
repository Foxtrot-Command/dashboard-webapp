...
import { FaTelegramPlane, FaTwitter, FaInstagram, FaDiscord, FaYoutube } from 'react-icons/fa'
...
const Stats = () => {
    return (
      ...
      <Box position="relative">
        ...
        <Box bg="whiteAlpha.100" mt={6} borderRadius={6} p={4} boxShadow="brand.shadow.md">
          <Flex
            flexWrap="wrap"
            minH="60px"
            height="100%"
