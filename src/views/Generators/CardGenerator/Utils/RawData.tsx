...
export const cardData = [
  ...
  },
  {
    ...
    description: '<strong>Challenge.</strong>\nWhen summoned\n<strong>desertion 4.</strong>',
    stats: {
      mana: 8,
      attack: 4,
      health: 7
  ...
  {
    name: 'Ihaido',
    description: '<strong>Quick Attack:</strong> Deals\ndamage before the\nenemy. <strong>Weaken.</strong>',
    stats: {
      mana: 6,
      attack: 5,
      health: 5
  ...
  {
    name: 'Bloody Roning',
    description: '<strong>Camouflage.</strong> When\nsummoned apply\n<strong>Bleeding 2</strong> to a unit.',
    stats: {
      mana: 2,
      attack: 1,
      health: 1
  ...
  {
    name: 'Rookie Riders',
    description: '<strong>Mobility:</strong>\nWhen summoned\n<strong>paralyze</strong> a unit.',
    stats: {
      mana: 4,
      attack: 4,
      health: 3
